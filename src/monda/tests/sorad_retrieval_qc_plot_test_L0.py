...
def run_example(platform_id = 'PML_SR001',
                start_time = datetime.datetime(2022,6,30,0,0,0),
                end_time = datetime.datetime(2022,6,30,23,59,59),
                bbox = None,
                target='L0_fsf', rrsalgorithm='3c',
...
def run_example_L0(platform_id = 'PML_SR001',
                start_time = datetime.datetime(2022,6,30,0,0,0),
                end_time = datetime.datetime(2022,6,30,23,59,59),
                bbox = None,
                target='L0_fsf', 
...
def unpack_response_L0(response):
  ...
  #  tilt_std      = np.array([response['result'][i]['tilt_std'] for i in range(len(response['result']))])
    ...
    ed_sensor_id  = response['result'][0]['l0_ed_sensor_id']
    lt_sensor_id  = response['result'][0]['l0_lt_sensor_id']
